...
*
*/
define('APP_BASE_URL', 'http://florahomesgc.com/florahomesgc_crm/');
...
*/
define('APP_ENC_KEY', 'e85b6b89ab6564eeff379c174af4426b');
...
define('APP_DB_USERNAME', 'florahomesgc_crm');
/* The password used to connect to the database */
define('APP_DB_PASSWORD', '##2019fhgcltd');
/* The name of the database you want to connect to */
define('APP_DB_NAME', 'florahomesgc_crm');
